...
# CD34+
CD34.data <- Read10X(data.dir = "~/AML9_Dx_CD34pos/filtered_feature_bc_matrix/")
...
# CD38+
CD38.data <- Read10X(data.dir = "~/AML9_Dx_CD38pos/filtered_feature_bc_matrix/")
...
combined.obj.AML <- merge(x = CD34, y = CD38, add.cell.ids = c("CD34","CD38") , project = "AML9_Dx")
...
#Filter the AML9_Dx cells (these are AML14 in Veletn's table)
Velten_proj_f <- Velten_proj[which(Velten_proj$patient=="AML14"),]
#Format the bc
