...
## 1. Integration of Dx t(8;21) samples
...
#### 1. Load samples processed from AML2.Rmd, AML8_Dx.Rmd and AML9_Dx.Rmd
AML2$orig.name <- "AML2"
AML2$old_clustering <- paste0("AML2_",Idents(AML2))
...
dt.list <- unlist(list(c(AML2,AML8_Dx,AML9_Dx)))
...
aux_df$LSC_label[which(aux_df$old_clustering%in%c("AML2_0","AML2_4","AML8_Dx_3","AML9_Dx_2"))] <- "LSC 34+"
aux_df$LSC_label[which(!(aux_df$old_clustering%in%c("AML2_0","AML2_4","AML8_Dx_3","AML9_Dx_2")) & aux_df$sample=="CD34")] <- "NonLSC 34+"
