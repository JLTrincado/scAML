...
```{r part1, fig.height=5, fig.width=10, message=FALSE}
library(matchSCore2)
...
# CD34+
CD34.data <- Read10X(data.dir = "~/AML4_Rx_CD34pos/filtered_feature_bc_matrix/")
...
# CD38+
CD38.data <- Read10X(data.dir = "~/AML4_Rx_CD38pos/filtered_feature_bc_matrix/")
...
combined.obj.AML <- merge(x = CD34, y = CD38, add.cell.ids = c("CD34","CD38") , project = "AML4_Rx")
...
#Filter the AML4_Rx cells (these are AML11 in Velten's table)
Velten_proj_f <- Velten_proj[which(Velten_proj$patient=="AML11"),]
#Format the bc
