...
## 1. Integration of Dx inv16 samples
...
#### 1. Load samples processed from AML3.Rmd, AML5.Rmd, AML7_Dx.Rmd and AML10_Dx.Rmd
AML3$orig.name <- "AML3"
AML3$old_clustering <- paste0("AML3_",Idents(AML3))
AML5$orig.name <- "AML5"
AML5$old_clustering <- paste0("AML5_",Idents(AML5))
...
dt.list <- unlist(list(c(AML3,AML5,AML7_Dx,AML10_Dx)))
...
aux_df$LSC_label[which(aux_df$old_clustering%in%c("AML3_0","AML5_1","AML7_Dx_0","AML10_Dx_5"))] <- "LSC 34+"
aux_df$LSC_label[which(aux_df$old_clustering%in%c("AML10_Dx_0","AML10_Dx_1"))] <- "LSC2 34+"
aux_df$LSC_label[which(!(aux_df$old_clustering%in%c("AML3_0","AML5_1","AML7_Dx_0","AML10_Dx_5","AML10_Dx_0","AML10_Dx_1")) & aux_df$sample=="CD34")] <- "NonLSC 34+"
aux_df$LSC_label <- factor(aux_df$LSC_label,levels = c("LSC AML16 34+","LSC 34+","NonLSC 34+","NonLSC 38+"))
...
#There is special upregulation of HBB in sample AML16
DefaultAssay(integrated.obj) <- "RNA"
HBB_plot <- FeaturePlot(integrated.obj,features = "HBB", pt.size = 1)
VlnPlot(integrated.obj,features = "HBB", group.by = "LSC_label")
DefaultAssay(integrated.obj) <- "integrated"
