...
# CD34+
CD34.data <- Read10X(data.dir = "~/AML11_Dx_CD34pos/filtered_feature_bc_matrix/")
...
# CD38+
CD38.data <- Read10X(data.dir = "~/AML11_Dx_CD38pos/filtered_feature_bc_matrix/")
...
combined.obj.AML <- merge(x = CD34, y = CD38, add.cell.ids = c("CD34","CD38") , project = "AML11_Dx")
...
#Filter the AML11_Dx cells (these are AML18 in Velten's table)
Velten_proj_f <- Velten_proj[which(Velten_proj$patient=="AML18"),]
#Format the bc
