...
# CD34+
CD34.data <- Read10X(data.dir = "~/AML11_Rx_CD34pos/filtered_feature_bc_matrix/")
...
# CD38+
CD38.data <- Read10X(data.dir = "~/AML11_Rx_CD38pos/filtered_feature_bc_matrix/")
...
combined.obj.AML <- merge(x = CD34, y = CD38, add.cell.ids = c("CD34","CD38") , project = "AML11_Rx")
...
#Filter the AML11_Rx cells (these are AML19 in Velten's table)
Velten_proj_f <- Velten_proj[which(Velten_proj$patient=="AML19"),]
#Format the bc
