...
# CD34+
CD34.data <- Read10X(data.dir = "~/AML1_CD34pos/filtered_feature_bc_matrix/")
...
# CD38+
CD38.data <- Read10X(data.dir = "~/AML1_CD38pos/filtered_feature_bc_matrix/")
...
combined.obj.AML <- merge(x = CD34, y = CD38, add.cell.ids = c("CD34","CD38") , project = "AML1")
...
#Filter the AML1 cells
Velten_proj_f <- Velten_proj[which(Velten_proj$patient=="AML1"),]
#Format the bc
