...
# CD34+
CD34.data <- Read10X(data.dir = "~/AML7_Rx_CD34pos/filtered_feature_bc_matrix/")
...
CD34 <- CellCycleScoring(object = CD34, s.genes, g2m.genes,set.ident = FALSE, nbin = 18)
...
# CD38+
CD38.data <- Read10X(data.dir = "~/AML7_Rx_CD38pos/filtered_feature_bc_matrix/")
...
combined.obj.AML <- merge(x = CD34, y = CD38, add.cell.ids = c("CD34","CD38") , project = "AML7_Rx")
...
#Filter the AML7_Rx cells (these are AML10 cells in Velten's table)
Velten_proj_f <- Velten_proj[which(Velten_proj$patient=="AML10"),]
#Format the bc
