...
# CD34+
CD34.data <- Read10X(data.dir = "~/AML2_11387_CD34pos/filtered_feature_bc_matrix/")
...
CD34 <- CellCycleScoring(object = CD34, s.genes, g2m.genes,set.ident = FALSE)
...
CD34 <- subset(x = CD34, subset = nFeature_RNA > 200 & nFeature_RNA < 5500  & percent.mito < 0.2 & log10_nCount_RNA > lower_bound)
CD34

# CD38+
CD38.data <- Read10X(data.dir = "~/AML2_11387_CD38pos/filtered_feature_bc_matrix/")
...
combined.obj.AML <- merge(x = CD34, y = CD38, add.cell.ids = c("CD34","CD38") , project = "AML2")
...
#Filter the AML2 cells
Velten_proj_f <- Velten_proj[which(Velten_proj$patient=="AML2"),]
#Format the bc
